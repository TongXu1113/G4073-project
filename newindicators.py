...
import os
os.chdir('C:/Users/Tong Xu/Google Drive/Schoolwork/Columbia/3rd Semester/Quant Methods in Investment Management/py')
...
filepath = 'C:/Users/Tong Xu/Google Drive/Schoolwork/Columbia/3rd Semester/Quant Methods in Investment Management/py/mu.csv'
...
for k in range(2,len(df_pos.index)):
    if df_pos.loc[k,'final1'] == 0:
        ...
        if count == 1:
            ...
            kkkk = df.loc[k,'idreturn']
            df_pos.loc[k,'return1'] = kkkk
...
df_pos['tlogret'] = df_pos['logreturn1'] * df_pos['final1']
df_pos['tret'] = df_pos['return1'] * df_pos['final1'] + 1
